...
import software.supernaturali.example.client.renderer.entity.BikeGeoRenderer;
import software.supernaturali.example.client.renderer.entity.ExampleGeoRenderer;
import software.supernaturali.example.client.renderer.entity.ReplacedCreeperRenderer;
import software.supernaturali.example.registry.EntityRegistry;
...
public class ClientListener implements ClientModInitializer {
	...
	public void onInitializeClient() {
		if (FabricLoader.getInstance().isDevelopmentEnvironment() && !GeckoLibMod.DISABLE_IN_DEV) {
			...
			EntityRendererRegistry.INSTANCE.register(EntityRegistry.BIKE_ENTITY, (context) -> new BikeGeoRenderer(context));
